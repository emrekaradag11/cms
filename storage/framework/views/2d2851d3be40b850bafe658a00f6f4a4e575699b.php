        ...
        <li class="list-group-item list-group-item-action" id="item-<?php echo e($t->id); ?>" data-content="<?php echo e($t->id); ?>">
            <div class="d-flex align-items-center justify-content-between customListElement">
                ...
                <div>
                    ...
                    <a data-id="<?php echo e($t->id); ?>" data-hidden="<?php echo e($t->hidden == '1' ? '0' : '1'); ?>" tabindex class="js-hidden btn btn-xs btn-xxs px-3 py-2 btn-linkedin"> <i class="fal <?php echo e($t->hidden == '1' ? 'fa-eye-slash' : 'fa-eye'); ?>"></i> </a>
